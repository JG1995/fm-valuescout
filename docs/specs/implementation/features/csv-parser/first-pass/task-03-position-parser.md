...
Parse FM position strings like `GK`, `D (LC)`, `AM (C), ST (C)`, `D/WB (L)` into structured `Vec<Position>` with `Role` and `Side` enums. This is the most complex single-field parser in the CSV importer.

## Files to Create/Modify

- Modify: `src-tauri/src/parser/positions.rs`

## Steps

- [ ] **Step 1: Write failing tests**

In `src-tauri/src/parser/positions.rs`:
...
Run: `cd src-tauri && cargo test --lib parser::positions`
Expected: All 10 tests PASS.

## Dependencies

- Task 01 (types.rs must define `Position`, `Role`, `Side`)

## Success Criteria

- All 10 position parsing tests pass.
- Handles: single role, combined roles (`D/WB`), multiple positions (`, `), sides in parens, no sides, empty/error cases.

## Tests

### Test 1: GK parses as Role::GK with no sides
**Feasibility:** ✅ Can be tested

### Test 2: D (LC) parses sides correctly
**Feasibility:** ✅ Can be tested

### Test 3: Multiple positions separated by comma
**Feasibility:** ✅ Can be tested

### Test 4: Combined roles D/WB split into two positions
**Feasibility:** ✅ Can be tested

### Test 5: M/AM combined roles
**Feasibility:** ✅ Can be tested

### Test 6: Triple side RLC
**Feasibility:** ✅ Can be tested

### Test 7: Plain role with no sides
**Feasibility:** ✅ Can be tested

### Test 8: Empty string returns error
**Feasibility:** ✅ Can be tested

### Test 9: Unrecognized role returns error
**Feasibility:** ✅ Can be tested

### Test 10: GK with center side
**Feasibility:** ✅ Can be tested
