...
- The Dependabot policy offers only guarded stable pnpm and Cargo patch automation. It does not grant release authority or auto-merge higher-risk, pre-`1.0.0`, prerelease, mixed, maintainer-modified, GitHub Actions, or NuGet updates.
