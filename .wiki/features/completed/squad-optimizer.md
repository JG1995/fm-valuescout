...
- A candidate must be in the team's configured club-family pool, meet the team's age rule, have IP and OOP suitability of at least 12, and have both role scores. Allocation deducts five hidden points for each phase below 16. A zero combined score remains eligible. Manual assignments reserve their player UID before optimization.
