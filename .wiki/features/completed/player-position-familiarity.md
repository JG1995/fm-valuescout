...
- Recorded positions use familiarity `> 0` in Search, Squad, Academy labels, profile pitch labels, and best-position selection. Playable positions use `>= 15` in profile summaries, goalkeeper mode, Planner, and optimizer eligibility.
...
- Confirm live Search, Squad, profile, Planner, optimizer, and Academy behavior. Include the exact optimizer boundary: 15 is eligible and 14 is not.
