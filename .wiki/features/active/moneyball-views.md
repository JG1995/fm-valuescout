...
- Sandboxed Vitest cannot spawn the Node child processes used by the release CLI tests. The focused feature suite and host release CLI suite passed; the broad host-suite capture remains noisy because jsdom reports unsupported `scrollTo` calls.
