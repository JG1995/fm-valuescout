...
1. **Utility bar** (`header-height` 56px). It contains Back and Forward, global player search, the active save selector, snapshot freshness, and **Load Data**. It stays first so global controls remain separate from destination navigation.
