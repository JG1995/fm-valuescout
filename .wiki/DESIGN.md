...
- **Preferred foot:** the selected-lane section has preferred foot (**Either**, **Left**, **Right**, or **Both**) and **Preferred** or **Strict** mode. Either means no foot restriction and disables the mode control. Controls use visible labels, native keyboard behavior, inline validation, and the existing failed-save draft retention.
