...
- [Optional Moneyball Analysis Views](./features/active/moneyball-views.md) — current-snapshot Moneyball percentile cohorts, optional Search and Player Profile views, virtualized raw-metric filtering, and one shared default-view preference (Linear JAY-19)
