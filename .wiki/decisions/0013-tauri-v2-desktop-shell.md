...
Ship HTTP alongside IPC so one codebase targets browser and desktop. Rejected — doubles the boundary, testing surface, and security model. Forks choose one primary mode at `/stack`.
