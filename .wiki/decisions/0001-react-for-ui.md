...
Svelte compiles components and often produces smaller bundles with less runtime code. The ecosystem and hiring pool are smaller than React. Cursor skills, TanStack integrations, and third-party component libraries skew toward React for web dashboards and internal tools.

### Vue

Vue is mature and approachable. This template already commits to the React-focused Cursor workflow and TanStack Router/Query integrations that assume React. A Vue fork would be a different template repository.
