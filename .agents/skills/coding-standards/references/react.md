...
Visual and interaction rules (contrast, focus, motion) live in `.wiki/DESIGN.md` and `.agents/skills/ui-design/SKILL.md`.
...
- Run `.agents/skills/security-audit/SKILL.md` before first deploy with auth or sensitive data. Load `security-audit/references/react.md`, `tauri.md`, and `rust.md` for WebView and IPC boundaries.
...
Paths from this file: `.agents/skills/coding-standards/references/react.md` → `.wiki/decisions/`.
