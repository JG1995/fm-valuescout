...
Load this file during every security audit. Stack-specific skills and references in `.agents/skills/` add sinks, platforms, and framework patterns when recon finds matching technology.
