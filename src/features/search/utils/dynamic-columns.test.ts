...
describe("dynamicColumnFields", () => {
  ...
  it("keeps General sorts and fields independent of Moneyball", () => {
    expect(isVisibleSortField("pa", [], "general")).toBe(true);
    expect(isVisibleSortField("moneyball.goals", [], "general")).toBe(false);
    expect(
      dynamicColumnFields(
        [
          {
